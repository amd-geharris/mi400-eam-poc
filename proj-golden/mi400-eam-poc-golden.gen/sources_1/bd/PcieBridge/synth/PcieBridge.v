...
module PcieBridge
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.AXIBUSCLOCK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.AXIBUSCLOCK, ASSOCIATED_BUSIF xPcieToDfx_AXI:xPcieToICAP_AXI, CLK_DOMAIN PcieBridge_xdma_0_0_axi_aclk, FREQ_HZ 125000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0" *) output AxiBusClock;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:diff_clock:1.0 PCIE_CLOCK CLK_N" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME PCIE_CLOCK, CAN_DEBUG false, FREQ_HZ 100000000" *) input [0:0]PCIE_CLOCK_clk_n;
  (* X_INTERFACE_INFO = "xilinx.com:interface:diff_clock:1.0 PCIE_CLOCK CLK_P" *) input [0:0]PCIE_CLOCK_clk_p;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 xPcieToDfx_AXI ARADDR" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME xPcieToDfx_AXI, ADDR_WIDTH 32, ARUSER_WIDTH 0, AWUSER_WIDTH 0, BUSER_WIDTH 0, CLK_DOMAIN PcieBridge_xdma_0_0_axi_aclk, DATA_WIDTH 32, FREQ_HZ 125000000, HAS_BRESP 1, HAS_BURST 0, HAS_CACHE 0, HAS_LOCK 0, HAS_PROT 1, HAS_QOS 0, HAS_REGION 0, HAS_RRESP 1, HAS_WSTRB 1, ID_WIDTH 0, INSERT_VIP 0, MAX_BURST_LENGTH 1, NUM_READ_OUTSTANDING 1, NUM_READ_THREADS 1, NUM_WRITE_OUTSTANDING 1, NUM_WRITE_THREADS 1, PHASE 0.0, PROTOCOL AXI4LITE, READ_WRITE_MODE READ_WRITE, RUSER_BITS_PER_BYTE 0, RUSER_WIDTH 0, SUPPORTS_NARROW_BURST 0, WUSER_BITS_PER_BYTE 0, WUSER_WIDTH 0" *) output [31:0]xPcieToDfx_AXI_araddr;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 xPcieToICAP_AXI TDATA" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME xPcieToICAP_AXI, CLK_DOMAIN PcieBridge_xdma_0_0_axi_aclk, FREQ_HZ 125000000, HAS_TKEEP 1, HAS_TLAST 1, HAS_TREADY 1, HAS_TSTRB 0, INSERT_VIP 0, LAYERED_METADATA undef, PHASE 0.0, TDATA_NUM_BYTES 4, TDEST_WIDTH 0, TID_WIDTH 0, TUSER_WIDTH 0" *) output [31:0]xPcieToICAP_AXI_tdata;
