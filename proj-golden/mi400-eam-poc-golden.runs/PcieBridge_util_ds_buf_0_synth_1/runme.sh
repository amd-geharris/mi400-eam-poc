...
HD_PWD='S:/projects/mi400-eam-poc/proj-golden/mi400-eam-poc-golden.runs/PcieBridge_util_ds_buf_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PcieBridge_util_ds_buf_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PcieBridge_util_ds_buf_0.tcl
