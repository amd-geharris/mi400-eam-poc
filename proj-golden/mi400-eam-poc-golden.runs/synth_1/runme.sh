...
HD_PWD='S:/projects/mi400-eam-poc/proj-golden/mi400-eam-poc-golden.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TopMi400EamPoc.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TopMi400EamPoc.tcl
