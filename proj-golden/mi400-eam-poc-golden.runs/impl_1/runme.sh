...
HD_PWD='S:/projects/mi400-eam-poc/proj-golden/mi400-eam-poc-golden.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TopMi400EamPoc.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TopMi400EamPoc.tcl -notrace
