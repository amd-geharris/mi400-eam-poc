...
HD_PWD='S:/projects/mi400-eam-poc/proj-golden/mi400-eam-poc-golden.runs/PcieBridge_axis_dwidth_converter_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PcieBridge_axis_dwidth_converter_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PcieBridge_axis_dwidth_converter_0_0.tcl
