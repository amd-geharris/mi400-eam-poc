...
architecture STRUCTURE of MicroBlazeCore_xbar_1_axi_crossbar_v2_1_32_addr_arbiter_sasd is
  ...
  attribute SOFT_HLUTNM of \m_atarget_enc[2]_i_3\ : label is "soft_lutpair36";
  attribute SOFT_HLUTNM of \m_atarget_enc[2]_i_5\ : label is "soft_lutpair3";
  ...
  attribute SOFT_HLUTNM of \m_atarget_hot[3]_i_4\ : label is "soft_lutpair36";
  ...
  attribute SOFT_HLUTNM of \m_atarget_hot[5]_i_5\ : label is "soft_lutpair4";
...
\gen_arbiter.m_amesg_i[27]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"BA"
    )
        port map (
...
\m_atarget_hot[1]_i_2\: unisim.vcomponents.LUT6
    generic map(
      ...
      I5 => \^gen_arbiter.m_amesg_i_reg[48]_0\(15),
...
entity MicroBlazeCore_xbar_1_axi_crossbar_v2_1_32_splitter is
  port (
    ...
    \s_axi_bvalid[1]_INST_0_i_1\ : in STD_LOGIC_VECTOR ( 2 downto 0 );
...
architecture STRUCTURE of MicroBlazeCore_xbar_1_axi_crossbar_v2_1_32_splitter is
  ...
  attribute SOFT_HLUTNM of \m_ready_d[1]_i_1__0\ : label is "soft_lutpair52";
  attribute SOFT_HLUTNM of \m_ready_d[2]_i_5\ : label is "soft_lutpair54";
...
\m_ready_d[2]_i_5\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"08300800"
        ...
        port map (
      I0 => m_axi_awready(3),
      I1 => \s_axi_bvalid[1]_INST_0_i_1\(0),
      I2 => \s_axi_bvalid[1]_INST_0_i_1\(1),
      I3 => \s_axi_bvalid[1]_INST_0_i_1\(2),
      I4 => m_axi_awready(1),
      O => \m_axi_awready[5]\
    );
\m_ready_d[2]_i_6\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00320002"
        ...
        port map (
      I0 => m_axi_awready(0),
      I1 => \s_axi_bvalid[1]_INST_0_i_1\(1),
      I2 => \s_axi_bvalid[1]_INST_0_i_1\(2),
...
\s_axi_wready[1]_INST_0_i_4\: unisim.vcomponents.LUT3
    generic map(
      ...
      I1 => \s_axi_bvalid[1]_INST_0_i_1\(2),
      I2 => \s_axi_bvalid[1]_INST_0_i_1\(0),
...
\s_axi_wready[1]_INST_0_i_5\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"FE"
        ...
        port map (
      I0 => \s_axi_bvalid[1]_INST_0_i_1\(0),
      I1 => \s_axi_bvalid[1]_INST_0_i_1\(1),
      I2 => \s_axi_bvalid[1]_INST_0_i_1\(2),
      O => \m_atarget_enc_reg[0]\
    );
...
architecture STRUCTURE of MicroBlazeCore_xbar_1_axi_register_slice_v2_1_31_axic_register_slice is
  ...
  attribute SOFT_HLUTNM of \m_payload_i[24]_i_4\ : label is "soft_lutpair45";
  attribute SOFT_HLUTNM of \m_payload_i[30]_i_3\ : label is "soft_lutpair48";
  ...
  attribute SOFT_HLUTNM of \m_payload_i[34]_i_7\ : label is "soft_lutpair47";
...
architecture STRUCTURE of MicroBlazeCore_xbar_1_axi_crossbar_v2_1_32_crossbar_sasd is
  ...
  signal sr_rvalid : STD_LOGIC;
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \s_axi_bresp[1]_INST_0_i_2\ : label is "soft_lutpair55";
...
addr_arbiter_inst: entity work.MicroBlazeCore_xbar_1_axi_crossbar_v2_1_32_addr_arbiter_sasd
     port map (
      ...
      \gen_arbiter.any_grant_reg_inv_0\ => splitter_aw_n_3,
      \gen_arbiter.grant_rnw_reg_0\ => addr_arbiter_inst_n_54,
      \gen_arbiter.grant_rnw_reg_1\ => addr_arbiter_inst_n_72,
      \gen_arbiter.grant_rnw_reg_2\ => addr_arbiter_inst_n_79,
      ...
      \m_axi_bvalid[4]\ => addr_arbiter_inst_n_87,
      m_axi_bvalid_0_sp_1 => addr_arbiter_inst_n_88,
...
\gen_decerr.decerr_slave_inst\: entity work.MicroBlazeCore_xbar_1_axi_crossbar_v2_1_32_decerr_slave
     port map (
      ...
      \gen_axilite.s_axi_awready_i_reg_1\ => addr_arbiter_inst_n_130,
      ...
      mi_bvalid(0) => mi_bvalid(6),
      mi_wready(0) => mi_wready(6),
      \s_axi_bvalid[0]\ => addr_arbiter_inst_n_87,
...
splitter_aw: entity work.MicroBlazeCore_xbar_1_axi_crossbar_v2_1_32_splitter
     port map (
      ...
      \m_ready_d_reg[0]_2\ => addr_arbiter_inst_n_87,
      \m_ready_d_reg[0]_3\ => addr_arbiter_inst_n_88,
      ...
      \s_axi_bvalid[1]_INST_0_i_1\(2 downto 0) => m_atarget_enc(2 downto 0)
    );
end STRUCTURE;
library IEEE;
use IEEE.STD_LOGIC_1164.ALL;
...
entity MicroBlazeCore_xbar_1_axi_crossbar_v2_1_32_axi_crossbar is
  ...
  attribute C_M_AXI_ADDR_WIDTH of MicroBlazeCore_xbar_1_axi_crossbar_v2_1_32_axi_crossbar : entity is "192'b000000000000000000000000000011000000000000000000000000000001000000000000000000000000000000010000000000000000000000000000000100000000000000000000000000000000110000000000000000000000000000010000";
  attribute C_M_AXI_BASE_ADDR : string;
  attribute C_M_AXI_BASE_ADDR of MicroBlazeCore_xbar_1_axi_crossbar_v2_1_32_axi_crossbar : entity is "384'";
...
architecture STRUCTURE of MicroBlazeCore_xbar_1 is
  ...
  attribute C_M_AXI_ADDR_WIDTH : string;
  attribute C_M_AXI_ADDR_WIDTH of inst : label is "192'b000000000000000000000000000011000000000000000000000000000001000000000000000000000000000000010000000000000000000000000000000100000000000000000000000000000000110000000000000000000000000000010000";
  attribute C_M_AXI_BASE_ADDR : string;
  attribute C_M_AXI_BASE_ADDR of inst : label is "384'";
  attribute C_M_AXI_READ_CONNECTIVITY : string;
