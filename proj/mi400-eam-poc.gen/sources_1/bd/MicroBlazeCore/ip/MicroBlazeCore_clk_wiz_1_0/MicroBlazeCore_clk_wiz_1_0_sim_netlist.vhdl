...
--               s:/projects/mi400-eam-poc/proj/mi400-eam-poc.gen/sources_1/bd/MicroBlazeCore/ip/MicroBlazeCore_clk_wiz_1_0/MicroBlazeCore_clk_wiz_1_0_sim_netlist.vhdl
...
entity MicroBlazeCore_clk_wiz_1_0_clk_wiz is
  port (
...
end MicroBlazeCore_clk_wiz_1_0_clk_wiz;

architecture STRUCTURE of MicroBlazeCore_clk_wiz_1_0_clk_wiz is
  signal clk_in1_MicroBlazeCore_clk_wiz_1_0 : STD_LOGIC;
  signal clk_out1_MicroBlazeCore_clk_wiz_1_0 : STD_LOGIC;
...
clkin1_ibufds: unisim.vcomponents.IBUFDS
    generic map(
      ...
      I => clk_in1_p,
      IB => clk_in1_n,
      O => clk_in1_MicroBlazeCore_clk_wiz_1_0
    );
clkout1_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clk_out1_MicroBlazeCore_clk_wiz_1_0,
      O => clk_out1
    );
mmcme4_adv_inst: unisim.vcomponents.MMCME4_ADV
    generic map(
      ...
      CLKIN1 => clk_in1_MicroBlazeCore_clk_wiz_1_0,
      CLKIN2 => '0',
      CLKINSEL => '1',
      CLKINSTOPPED => NLW_mmcme4_adv_inst_CLKINSTOPPED_UNCONNECTED,
      CLKOUT0 => clk_out1_MicroBlazeCore_clk_wiz_1_0,
...
entity MicroBlazeCore_clk_wiz_1_0 is
  ...
  attribute NotValidForBitStream of MicroBlazeCore_clk_wiz_1_0 : entity is true;
end MicroBlazeCore_clk_wiz_1_0;

architecture STRUCTURE of MicroBlazeCore_clk_wiz_1_0 is
begin
inst: entity work.MicroBlazeCore_clk_wiz_1_0_clk_wiz
     port map (
      clk_in1_n => clk_in1_n,
      clk_in1_p => clk_in1_p,
      clk_out1 => clk_out1,
