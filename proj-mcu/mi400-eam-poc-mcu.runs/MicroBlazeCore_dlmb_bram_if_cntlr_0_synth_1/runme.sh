...
HD_PWD='S:/projects/mi400-eam-poc/proj-mcu/mi400-eam-poc-mcu.runs/MicroBlazeCore_dlmb_bram_if_cntlr_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MicroBlazeCore_dlmb_bram_if_cntlr_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MicroBlazeCore_dlmb_bram_if_cntlr_0.tcl
