...
HD_PWD='S:/projects/mi400-eam-poc/proj-mcu/mi400-eam-poc-mcu.runs/MicroBlazeCore_Axi4FabricBridge_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MicroBlazeCore_Axi4FabricBridge_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MicroBlazeCore_Axi4FabricBridge_0_0.tcl
