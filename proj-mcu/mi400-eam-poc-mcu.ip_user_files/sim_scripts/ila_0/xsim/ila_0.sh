...
# set xvlog options
xvlog_opts="--incr --relax  -L xdma_v4_1_29"
...
simulate()
{
  xsim ila_0 -key {Behavioral:sim_1:Functional:ila_0} -tclbatch cmd.tcl -protoinst "protoinst_files/PcieBridge.protoinst" -protoinst "protoinst_files/MicroBlazeCore.protoinst" -log simulate.log
}
