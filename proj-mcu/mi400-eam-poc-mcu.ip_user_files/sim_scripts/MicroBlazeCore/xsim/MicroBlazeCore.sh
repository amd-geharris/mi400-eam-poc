...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L microblaze_v11_0_13 -L xil_defaultlib -L axi_lite_ipif_v3_0_4 -L lib_cdc_v1_0_3 -L lib_pkg_v1_0_4 -L axi_timer_v2_0_33 -L lib_srl_fifo_v1_0_4 -L axi_uartlite_v2_0_35 -L lmb_v10_v3_0_14 -L lmb_bram_if_cntlr_v4_0_24 -L blk_mem_gen_v8_4_8 -L generic_baseblocks_v2_1_2 -L axi_infrastructure_v1_1_0 -L axi_register_slice_v2_1_31 -L fifo_generator_v13_2_10 -L axi_data_fifo_v2_1_30 -L axi_crossbar_v2_1_32 -L axi_intc_v4_1_19 -L xlconcat_v2_1_6 -L proc_sys_reset_v5_0_15 -L axi_clock_converter_v2_1_30 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot MicroBlazeCore xil_defaultlib.MicroBlazeCore xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim MicroBlazeCore -key {Behavioral:sim_1:Functional:MicroBlazeCore} -tclbatch cmd.tcl -protoinst "protoinst_files/MicroBlazeCore.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb MicroBlazeCore.wdb xsim.dir libdpi.so)
