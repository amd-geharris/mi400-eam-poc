...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../mi400-eam-poc-mcu.gen/sources_1/bd/MicroBlazeCore/ipshared/ec67/hdl" \
  ...
  vlogan -work blk_mem_gen_v8_4_8 $vlogan_opts +v2k +incdir+"../../../../mi400-eam-poc-mcu.gen/sources_1/bd/MicroBlazeCore/ipshared/ec67/hdl" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../mi400-eam-poc-mcu.gen/sources_1/bd/MicroBlazeCore/ipshared/ec67/hdl" \
  "../../../bd/MicroBlazeCore/ip/MicroBlazeCore_lmb_bram_0/sim/MicroBlazeCore_lmb_bram_0.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work generic_baseblocks_v2_1_2 $vlogan_opts +v2k +incdir+"../../../../mi400-eam-poc-mcu.gen/sources_1/bd/MicroBlazeCore/ipshared/ec67/hdl" \
  "../../../../mi400-eam-poc-mcu.gen/sources_1/bd/MicroBlazeCore/ipshared/0c28/hdl/generic_baseblocks_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work axi_infrastructure_v1_1_0 $vlogan_opts +v2k +incdir+"../../../../mi400-eam-poc-mcu.gen/sources_1/bd/MicroBlazeCore/ipshared/ec67/hdl" \
  "../../../../mi400-eam-poc-mcu.gen/sources_1/bd/MicroBlazeCore/ipshared/ec67/hdl/axi_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work axi_register_slice_v2_1_31 $vlogan_opts +v2k +incdir+"../../../../mi400-eam-poc-mcu.gen/sources_1/bd/MicroBlazeCore/ipshared/ec67/hdl" \
  "../../../../mi400-eam-poc-mcu.gen/sources_1/bd/MicroBlazeCore/ipshared/92b2/hdl/axi_register_slice_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work fifo_generator_v13_2_10 $vlogan_opts +v2k +incdir+"../../../../mi400-eam-poc-mcu.gen/sources_1/bd/MicroBlazeCore/ipshared/ec67/hdl" \
  ...
  vlogan -work axi_data_fifo_v2_1_30 $vlogan_opts +v2k +incdir+"../../../../mi400-eam-poc-mcu.gen/sources_1/bd/MicroBlazeCore/ipshared/ec67/hdl" \
  "../../../../mi400-eam-poc-mcu.gen/sources_1/bd/MicroBlazeCore/ipshared/9692/hdl/axi_data_fifo_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work axi_crossbar_v2_1_32 $vlogan_opts +v2k +incdir+"../../../../mi400-eam-poc-mcu.gen/sources_1/bd/MicroBlazeCore/ipshared/ec67/hdl" \
  ...
  vlogan -work xlconcat_v2_1_6 $vlogan_opts +v2k +incdir+"../../../../mi400-eam-poc-mcu.gen/sources_1/bd/MicroBlazeCore/ipshared/ec67/hdl" \
  ...
  vlogan -work axi_clock_converter_v2_1_30 $vlogan_opts +v2k +incdir+"../../../../mi400-eam-poc-mcu.gen/sources_1/bd/MicroBlazeCore/ipshared/ec67/hdl" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.MicroBlazeCore xil_defaultlib.glbl -o MicroBlazeCore_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./MicroBlazeCore_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key MicroBlazeCore_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc MicroBlazeCore_simv.daidir vcs_lib c.obj)
